...
def get_skeleton(connections, markers):
    skeletons = []
...
def get_pose_params(markers: List[str]) -> Dict[str, List]:
    full_state = [
        ...
        'theta_14', 'theta_15',      # l_front_ankle, r_front_ankle
        'theta_16', 'theta_17',      # l_back_ankle, r_back_ankle
        'x_l', 'y_l', 'z_l',
    ]
...
def get_3d_marker_coords(states: Dict, idx, tau: float = 0.0, directions: bool = False, intermode: str = 'pos'):
...
def get_all_marker_coords_from_states(states, n_cam: int, directions: bool = False, intermode: str = 'pos') -> List:
